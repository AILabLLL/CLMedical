...
class SequentialNCT(ContinualDataset):
    ...
    NAME = 'seq-nct-224-allimage'
    SETTING = 'class-il'
    N_TASKS = 3
    N_CLASSES_PER_TASK = 3
    N_CLASSES = 9
    SIZE = (224, 224)
    MEAN, STD = [0.7407602678765357, 0.5331834983258512, 0.7059645662899071], [0.1645373747807355, 0.21727045770713097, 0.15716628264487972]  # ImageNet 标准值
